    ...
    <div className="space-y-8 h-full flex flex-col pb-12">
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-3">
          ...
          <button className="flex items-center gap-2 px-6 py-3 bg-slate-900 rounded-xl font-bold text-xs uppercase tracking-widest text-white hover:bg-slate-800 transition-all shadow-lg shadow-slate-900/10">
            <Upload className="w-4 h-4" /> Upload intelligence
          </button>
        </div>
      </div>
        ...
        <div className="md:col-span-2 space-y-8">
           ...
           >
              ...
              <div className="grid grid-cols-1 gap-3">
                 ...
                 />
                 <DocItem 
                   title="Scale Strategy Roadmap 2026" 
                   size="512 KB" 
                   date="May 05, 2026" 
                   verified={true}
                 />
           ...
           >
              ...
              <div className="space-y-8">
                 <div className="flex justify-between items-end border-b border-slate-50 pb-4">
                    <span className="text-4xl font-bold text-slate-900 tracking-tighter">12</span>
                    <span className="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-1">TOTAL FILES</span>
                 </div>
                 <div className="flex justify-between items-end">
                    <span className="text-4xl font-bold text-slate-900 tracking-tighter">24.5<span className="text-lg">MB</span></span>
...
function DocItem({ title, size, date, verified }: any) {
  return (
    <div className="group flex items-center justify-between p-6 rounded-2xl border border-slate-100 bg-slate-50/20 hover:bg-emerald-50/50 hover:border-emerald-100 transition-all">
       ...
       <div className="flex items-center gap-6">
          ...
          <button className="p-3 rounded-xl hover:bg-white text-slate-400 hover:text-emerald-600 transition-all border border-transparent hover:border-slate-100 shadow-sm hover:shadow-md">
