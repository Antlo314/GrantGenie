            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-300">
                  {versions.length} version{versions.length !== 1 ? 's' : ''} · {activity.length} events
                </p>
              </div>
            </div>
                        ...
                        <div className="flex items-start justify-between gap-3">
                          <div className="min-w-0 flex-1">
                            ...
                            <p className="text-xs font-bold text-slate-800 mt-1">
                              ...
                              <span className="text-slate-400 font-medium ml-2">by {v.savedByName}</span>
                            </p>
                          ...
                          <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity shrink-0">
                            <button
                              ...
                              className="px-2.5 py-1.5 text-[10px] font-bold rounded-lg border border-slate-200 bg-white hover:bg-slate-50 text-slate-600 transition-colors"
                            >
                            ...
                            {!isLatest && (
                              <button
                                ...
                                className="px-2.5 py-1.5 text-[10px] font-bold rounded-lg border border-violet-200 bg-violet-50 hover:bg-violet-100 text-violet-700 transition-colors"
                              >
                      ...
                      return (
                        <div key={entry.id || i} className="flex items-start gap-3 mb-4 relative">
                          ...
                          <div className="min-w-0 flex-1 pt-1">
                            ...
                            {entry.details && (
                              <p className="text-[10px] text-slate-500 mt-1 font-medium bg-slate-50 rounded-lg px-2.5 py-1.5 border border-slate-100">
                                {entry.details}
                              </p>
                            )}
                          </div>
              ...
              <div className="p-4 border-b border-slate-100 flex items-center justify-between shrink-0">
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="px-3 py-1.5 text-[10px] font-bold rounded-lg border border-violet-200 bg-violet-50 hover:bg-violet-100 text-violet-700 transition-colors"
                  >
                    <RotateCcw className="w-3 h-3 inline mr-1 -mt-0.5" />
